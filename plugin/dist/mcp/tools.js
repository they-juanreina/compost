...
export const TOOLS = [
    ...
    },
    {
        ...
        description: "Write an analytic memo — your dated interpretive note about the corpus, a code, or a theme (the reasoning behind a move, a reflexive observation, a pattern hunch). Anchor it to what it's about. Lands as an AI [draft] until a researcher endorses (compost endorse) — propose, never self-approve.",
        readOnly: false,
        aiAuthored: true,
        inputSchema: {
            type: 'object',
